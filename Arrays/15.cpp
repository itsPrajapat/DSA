/* An arithematic array is an array that contains at least two integers and the differences between consecutive integers are equal. For example [9,10], [3,3,3], and [9,7,3,5] are arithematic arrays, while [1,3,3,7], [2,1,2] and [1,2,4] are not arithematic arrays.
